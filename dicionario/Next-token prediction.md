---
descrição: What the model actually does. Samples one next token from the context, appends it, and runs again. Its only mode of operation.
---
...
"How does the [agente](./agente.md) 'decide' to call a tool?"
