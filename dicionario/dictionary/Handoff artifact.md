---
descrição: A document used as the carry mechanism for a handoff — written by one session to be read by another.
---
...
"How do I split this between the planning [agente](./agente.md) and the implementing one?"
